...
No address, deployment configuration, wallet configuration, Permit2 flow, WLD payment, withdrawal, redemption, fee routing, liquidity, custody, or World Portal change is included in this repository change. CGOLD's ordinary ERC-20 movement exists only inside the source contract and is not live until a separately authorized deployment.
