...
| --- | --- | --- |
| `src/CivilizationGame.sol` | Source-only; not independently audited | Wallet-only `registerWallet()`, dormant legacy World ID ABI compatibility, and direct player-signed game state. |
