...
export const CIVILIZATION_GAME_ABI = [
  ...
  { type: 'function', name: 'train', stateMutability: 'nonpayable', inputs: [{ name: 'troop', type: 'uint8' }, { name: 'amount', type: 'uint256' }], outputs: [] },
  {
    type: 'function', name: 'startRaid', stateMutability: 'nonpayable',
    inputs: [{ name: 'defender', type: 'address' }, { name: 'spear', type: 'uint256' }, { name: 'archer', type: 'uint256' }, { name: 'rider', type: 'uint256' }], outputs: [],
  },
