...
const copy = {
  "de-DE": {
    ...
    appearance: "Dorflayout",
    appearanceDescription:
      "Vorschau ist nur lokal, bis du das Layout ausdrücklich anwendest.",
    appearanceClassic: "Klassisch",
    appearanceDusk: "Dämmerung",
    appearanceDawn: "Morgendämmerung",
    appearanceApply: "Anwenden",
    appearanceApplying: "Wird angewendet …",
    appearanceReset: "Auf klassisch zurücksetzen",
    appearanceSaved: "Dorflayout gespeichert.",
    appearanceUnavailable:
      "Dorflayout konnte nicht gespeichert werden. Klassisch bleibt aktiv.",
  ...
  "en-US": {
    ...
    appearanceDescription:
      "The preview stays local until you explicitly apply the appearance.",
    appearanceClassic: "Classic",
    appearanceDusk: "Dusk",
    appearanceDawn: "Dawn",
    appearanceApply: "Apply",
    appearanceApplying: "Applying…",
    appearanceReset: "Reset to classic",
    appearanceSaved: "Village appearance saved.",
    appearanceUnavailable:
      "Village appearance could not be saved. Classic remains active.",
    settingsClose: "Close",
    account: "Account",
